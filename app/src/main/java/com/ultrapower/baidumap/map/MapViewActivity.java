...
import com.ultrapower.baidumap.location.BaiduLocationUtil;
import com.ultrapower.baidumap.login.LoginActivity;
...
public class MapViewActivity extends AppCompatActivity implements IMapViewActivity{
    ...
    public void setLocation(){
        ...
        BaiduLocationUtil.getInstance().getLocation(getApplicationContext(),myListener);
        Log.e("经纬度",mLat+"  "+mLng);
    }
...
//    };
    ...
    protected void onDestroy() {
        super.onDestroy();
        mBaiduMap.onDestroy();
        BaiduLocationUtil.getInstance().unRegister(myListener);
    }
